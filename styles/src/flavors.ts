...
export const STREETS: Flavor = {
  ...
  minor_b: "#BEC5D8",
  link: "#A1ABC6",
  major_casing_early: "#A1ABC6",
  major: "#BEC5D8",
  highway_casing_early: "#A1ABC6",
  highway: "#A1ABC6",
  ...
  bridges_minor_casing: "#A1ABC6",
  bridges_link_casing: "#e0e0e0",
  bridges_major_casing: "#A1ABC6",
  bridges_highway_casing: "#A1ABC6",
  bridges_other: "#EEEAEE",
  bridges_minor: "#A1ABC6",
  bridges_link: "#ffffff",
  bridges_major: "#BEC5D8",
  bridges_highway: "#A1ABC6",

  roads_label_minor: "#333344",
  roads_label_minor_halo: "#ffffff",
  roads_label_major: "#333344",
  roads_label_major_halo: "#ffffff",
  ocean_label: "#728dd4",
  subplace_label: "#333344",
